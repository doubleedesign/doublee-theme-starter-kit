...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header container">
		<div class="row">
			<div class="site-branding col-xs-12 col-md-4 col-xl-3">
				<?php
				the_custom_logo();
			...
			<nav id="site-navigation" class="main-navigation col-xs-12 col-lg-8 col-xl-9">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e('Primary Menu', 'starterkit'); ?></button>
				<?php
				wp_nav_menu(
					array(
