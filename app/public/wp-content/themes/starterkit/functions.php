...
function starterkit_setup() {
	/*
		...
		* If you're building a theme based on starterkit, use a find and replace
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'starterkit' ),
		)
	);
...
function starterkit_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'starterkit' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'starterkit' ),
...
function starterkit_scripts() {
	wp_enqueue_style( 'starterkit-style', get_stylesheet_uri(), array(), _S_VERSION );
